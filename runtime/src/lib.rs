...
pub use frame_support::{
	...
	StorageValue,
	sp_runtime::{FixedU128, FixedPointNumber}
};
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		// Include the custom logic from the pallet-defi in the runtime.
...
impl_runtime_apis! {
	...
	impl pallet_defi_rpc_runtime_api::DefiModuleAPI<Block, AccountId, Balance> for Runtime {
		...
		fn get_borrowing_apy() -> pallet_defi_rpc_runtime_api::BalanceInfo<Balance> {
			DefiModule::get_borrowing_apy()
		}
	}
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		fn dispatch_benchmark(
			...
			add_benchmark!(params, batches, pallet_defi, DefiModule);
